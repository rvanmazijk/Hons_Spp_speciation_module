...
Given the diversity of species concepts used (or ignore) in mammal alpha-taxonomy, and the seemingly similarly diverse lines of evidence used to delimit species, it is difficult to draw general conclusions about speciation processes 
